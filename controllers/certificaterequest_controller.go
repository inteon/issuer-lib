...
// CertificateRequestController reconciles a CertificateRequest object
...
func (r *CertificateRequestController) matchIssuerType(requestObject client.Object) (v1alpha1.Issuer, types.NamespacedName, error) {
...
func (r *CertificateRequestController) Init() *CertificateRequestController {
...
func (r *CertificateRequestController) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	if err := setupCertificateRequestControllerScheme(mgr.GetScheme()); err != nil {
		return err
	}
...
func setupCertificateRequestControllerScheme(scheme *runtime.Scheme) error {
