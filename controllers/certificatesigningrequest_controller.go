...
// CertificateSigningRequestController reconciles a CertificateRequest object
type CertificateSigningRequestController struct {
	RequestController
}
...
func (r *CertificateSigningRequestController) matchIssuerType(requestObject client.Object) (v1alpha1.Issuer, types.NamespacedName, error) {
...
func (r *CertificateSigningRequestController) Init() *CertificateSigningRequestController {
...
func (r *CertificateSigningRequestController) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	if err := setupCertificateSigningRequestControllerScheme(mgr.GetScheme()); err != nil {
		return err
	}
...
func setupCertificateSigningRequestControllerScheme(scheme *runtime.Scheme) error {
